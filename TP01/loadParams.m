...
error_tolerance = 0.0005;                % Cota de error para corte del algoritmo
...
num_hidden = 10+1;   % numero de neuronas en la capa oculta, incluye el BIAS    
num_samples = 4;   % Cantidad de muestras que se toman en el intervalo de la funcion
...
beta = 1;           % Constante de escalamiento para la funcion de activacion
